...
// $("#searchresult").on("click", ".instructions", function(event) {
//     event.preventDefault();
...
function appendFood(list) {
    ...
    for (var i = 0; i < list.length; i++) {
        ...
        // foodimage.css({"width":"auto", "height":"auto"})
        var morefood = $("<a>").attr("class", "btn-floating halfway-fab waves-effect waves-light red");
        morefood.attr("id", (list[i].id));
